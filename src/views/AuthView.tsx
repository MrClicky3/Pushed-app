...
export default function AuthView({ onSignIn, onSignUp, onResend, onVerifyOtp, onResetPassword, onGoogle }: Props) {
  ...
  if (step === 'form') {
    return (
      <div
        ...
        style={{ background: '#0a0908', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}
      >
  ...
  return (
    <div
      ...
      style={{
        background: 'radial-gradient(ellipse 100% 50% at 50% -10%, rgba(244,241,236,0.09) 0%, #0a0908 55%)',
